  ...
  return (
    <ActiveSectionProvider>
      ...
      <div
        ...
        className="site-container grid h-screen grid-cols-1 overflow-y-auto pt-(--header-height) sm:grid-cols-[300px_auto] sm:grid-rows-[auto_1fr] sm:gap-x-4 sm:pt-[calc(var(--header-height)+2rem)] sm:pb-8 md:gap-x-8"
      >
        <Hero />
