...
>(({ className, ...props }, ref) => (
  ...
  >
    ...
    <SwitchPrimitives.Thumb
      className={cn(
        "border-pointer-events-none shadow-base block h-[26px] w-[26px] rounded-full bg-background ring-0 transition-transform data-[state=checked]:translate-x-[calc(100%-3px)] data-[state=unchecked]:translate-x-[3px] [&_svg]:size-5",
      )}
    >
      {props.children}
    </SwitchPrimitives.Thumb>
