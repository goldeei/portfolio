export const StorybookIcon = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg width="24" height="24" viewBox="-2 -2 28 28" fill="currentColor" xmlns="http://www.w3.org/2000/svg" {...props}>
